	...
	<head>
		...
		<script>						
			$(document).ready(function() {		
				if (!checkStatus()) {
					$("#pane").css("margin-left", "20%");
					$("#doctitle").css("margin-left", "40%");
					$("#doctitle").attr("disabled", "disabled");
					$("#doctitle").css("opacity", "1");
					$("#doc").removeAttr("contentEditable");
					$("#doc").css("word-wrap", "break-word");
				}
				view(window.location.search.substr(1),'doc');
				saveChanges("", "", false);
